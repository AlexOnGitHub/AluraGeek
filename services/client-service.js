//Conexion
const listaProductos = () => fetch('https://alura-geek-api-zeta.vercel.app/productos').then(respuesta => respuesta.json());

const crearProducto = (nombre, precio, imagen, categoria, descripcion) => {
  return fetch('https://alura-geek-api-zeta.vercel.app/productos', {
    method: "POST",
    headers: {
...
const eliminarProducto = (id) => {
  return fetch(`https://alura-geek-api-zeta.vercel.app/productos/${id}`, {
    method: "DELETE"
  });
};
...
const detalleProducto = async (id) => {
  return fetch(`https://alura-geek-api-zeta.vercel.app/productos/${id}`).then( respuesta => respuesta.json());
};
